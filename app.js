...
const translations = {
  en: {
    ...
    prog_adore_title: "Eucharistic Adoration",
//    prog_adore_subtitle: "replaceme",
//    prog_adore_desc: "replaceme",
    prog_conference_title: "Steubenville Conferences",
//    prog_conference_subtitle: "replaceme",
//    prog_conference_desc: "replaceme",
...
const getAdultPrograms = (t) => ({
  ...
  eucharistic_adoration: {
    key: 'eucharistic_adoration',
    title: t('prog_adore_title'),
    subtitle: t('prog_adore_subtitle'),
    description: t('prog_adore_desc'),
    icon: '◆',
    color: 'var(--gold)',
  },
  conferences: {
    key: 'conferences',
    title: t('prog_conference_title'),
    subtitle: t('prog_conference_subtitle'),
    description: t('prog_conference_desc'),
    icon: '◆',
    color: 'var(--gold)',
  },
});
