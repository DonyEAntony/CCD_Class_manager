...
const translations = {
  en: {
    ...
    clear_button: 'Clear',
    undo_button: 'Undo',
    attendance_marked_all_present_toast: 'Marked all %s students present.',
    attendance_cleared_toast: "Cleared today's attendance for %s students.",
    attendance_undo_restored_toast: 'Attendance restored.',
  ...
  es: {
    ...
    attendance_marked_all_present_toast: 'Se marcaron %s estudiantes como presentes.',
    attendance_cleared_toast: 'Se borró la asistencia de hoy para %s estudiantes.',
    attendance_undo_restored_toast: 'Asistencia restaurada.',
